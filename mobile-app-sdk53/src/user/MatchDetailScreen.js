    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.matchTitle}>
          {match.home_team_name || 'فريق 1'} vs {match.away_team_name || 'فريق 2'}
        </Text>
      ...
      <View style={styles.section}>
        ...
        <Info label="التاريخ" value={match.match_date ? new Date(match.match_date).toLocaleDateString() : 'غير محدد'} />
