...
export default function AdminTeamCrudScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Save or update team
      if (editingId) {
        await dataService.updateTeam(editingId, teamData);
        ...
        {activeTab === 'media' && (
          ...
          >
            <View style={styles.formCard}>
              <View style={styles.formCardHeader}>
                <Ionicons name="image-outline" size={24} color="#1e3c72" />
                <Text style={styles.formCardTitle}>Team Banner</Text>
              </View>
              ...
              <View style={styles.formCardBody}>
                {bannerImage ? (
                  ...
                  <View style={styles.emptyBannerPlaceholder}>
                    ...
                    <Text style={styles.emptyBannerText}>No banner image selected</Text>
                  </View>
                )}
                ...
                >
                  <Ionicons name="image" size={20} color="#fff" />
                  <Text style={styles.bannerActionButtonText}>
                    {bannerImage ? 'Change Banner' : 'Select Banner'}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View style={styles.listContainer}>
          ...
          <CrudList
            ...
            onEdit={(item) => {
              ...
              setTeamStatus(item.status || 'active');
              ...
              if (item.banner_url) {
                setBannerImage({ uri: item.banner_url });
              } else {
                setBannerImage(null);
              }
            ...
            renderItemFields={(item) => (
              <View style={styles.listItem}>
                ...
                <View style={[styles.statusIndicator, styles[`status_${item.status || 'active'}`]]} />
              </View>
            )}
            extraActions={[
              {
